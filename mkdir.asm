...
main(int argc, char *argv[])
{
  ...
  25:	e8 16 03 00 00       	call   340 <mkdir>
  ...
  44:	c7 44 24 04 cf 07 00 	movl   $0x7cf,0x4(%esp)
  4b:	00 
...
printf(int fd, const char *fmt, ...)
{
 ...
 618:	e9 7e fe ff ff       	jmp    49b <printf+0x5b>
          s = "(null)";
 61d:	bb eb 07 00 00       	mov    $0x7eb,%ebx
        while(*s != 0){
 ...
 631:	a1 ac 0a 00 00       	mov    0xaac,%eax
{
 ...
 677:	5b                   	pop    %ebx
  freep = p;
 678:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 67d:	5e                   	pop    %esi
 67e:	5f                   	pop    %edi
 67f:	5d                   	pop    %ebp
 ...
 68e:	72 ce                	jb     65e <free+0x2e>
{
 ...
 6b1:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 6b4:	a3 ac 0a 00 00       	mov    %eax,0xaac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 741:	e8 ea fe ff ff       	call   630 <free>
  return freep;
 746:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	b8 b0 0a 00 00       	mov    $0xab0,%eax
 785:	ba b0 0a 00 00       	mov    $0xab0,%edx
    base.s.size = 0;
 78a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 78c:	a3 ac 0a 00 00       	mov    %eax,0xaac
    base.s.size = 0;
 791:	b8 b0 0a 00 00       	mov    $0xab0,%eax
    base.s.ptr = freep = prevp = &base;
 796:	89 15 b0 0a 00 00    	mov    %edx,0xab0
    base.s.size = 0;
 79c:	89 0d b4 0a 00 00    	mov    %ecx,0xab4
