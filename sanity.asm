...
main(int argc, char *argv[]){
  ...
  5d:	e8 66 02 00 00       	call   2c8 <exit>
  62:	66 90                	xchg   %ax,%ax
  64:	66 90                	xchg   %ax,%ax
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 608:	e9 7e fe ff ff       	jmp    48b <printf+0x5b>
          s = "(null)";
 60d:	bb e0 07 00 00       	mov    $0x7e0,%ebx
        while(*s != 0){
 ...
 621:	a1 a0 0a 00 00       	mov    0xaa0,%eax
{
 ...
 667:	5b                   	pop    %ebx
  freep = p;
 668:	a3 a0 0a 00 00       	mov    %eax,0xaa0
}
 66d:	5e                   	pop    %esi
 66e:	5f                   	pop    %edi
 66f:	5d                   	pop    %ebp
 ...
 67e:	72 ce                	jb     64e <free+0x2e>
{
 ...
 6a1:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 6a4:	a3 a0 0a 00 00       	mov    %eax,0xaa0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 731:	e8 ea fe ff ff       	call   620 <free>
  return freep;
 736:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	b8 a4 0a 00 00       	mov    $0xaa4,%eax
 775:	ba a4 0a 00 00       	mov    $0xaa4,%edx
    base.s.size = 0;
 77a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 77c:	a3 a0 0a 00 00       	mov    %eax,0xaa0
    base.s.size = 0;
 781:	b8 a4 0a 00 00       	mov    $0xaa4,%eax
    base.s.ptr = freep = prevp = &base;
 786:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
    base.s.size = 0;
 78c:	89 0d a8 0a 00 00    	mov    %ecx,0xaa8
