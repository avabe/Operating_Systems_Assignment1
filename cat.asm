...
main(int argc, char *argv[])
{
  ...
  2b:	e8 a8 03 00 00       	call   3d8 <open>
  ...
  45:	e8 76 03 00 00       	call   3c0 <close>
  for(i = 1; i < argc; i++){
  ...
  56:	e8 3d 03 00 00       	call   398 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  5b:	8b 07                	mov    (%edi),%eax
  5d:	c7 44 24 04 9b 08 00 	movl   $0x89b,0x4(%esp)
  64:	00 
 ...
 161:	31 d2                	xor    %edx,%edx
{
 ...
 169:	53                   	push   %ebx
 16a:	8b 75 0c             	mov    0xc(%ebp),%esi
 16d:	8b 5d 10             	mov    0x10(%ebp),%ebx
    while((n--) > 0 && ((*s++ = *t++) != 0));
 170:	eb 12                	jmp    184 <strncpy+0x24>
 ...
 182:	74 08                	je     18c <strncpy+0x2c>
 184:	89 d9                	mov    %ebx,%ecx
 186:	29 d1                	sub    %edx,%ecx
 188:	85 c9                	test   %ecx,%ecx
 18a:	7f ec                	jg     178 <strncpy+0x18>
    return os;
}
 18c:	5b                   	pop    %ebx
 18d:	5e                   	pop    %esi
...
printf(int fd, const char *fmt, ...)
{
 ...
 6d8:	e9 7e fe ff ff       	jmp    55b <printf+0x5b>
          s = "(null)";
 6dd:	bb b0 08 00 00       	mov    $0x8b0,%ebx
        while(*s != 0){
 ...
 6f1:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 737:	5b                   	pop    %ebx
  freep = p;
 738:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 73d:	5e                   	pop    %esi
 73e:	5f                   	pop    %edi
 73f:	5d                   	pop    %ebp
 ...
 74e:	72 ce                	jb     71e <free+0x2e>
{
 ...
 771:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 774:	a3 a0 0b 00 00       	mov    %eax,0xba0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 801:	e8 ea fe ff ff       	call   6f0 <free>
  return freep;
 806:	8b 15 a0 0b 00 00    	mov    0xba0,%edx
 ...
 83f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 840:	b8 a4 0b 00 00       	mov    $0xba4,%eax
 845:	ba a4 0b 00 00       	mov    $0xba4,%edx
    base.s.size = 0;
 84a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 84c:	a3 a0 0b 00 00       	mov    %eax,0xba0
    base.s.size = 0;
 851:	b8 a4 0b 00 00       	mov    $0xba4,%eax
    base.s.ptr = freep = prevp = &base;
 856:	89 15 a4 0b 00 00    	mov    %edx,0xba4
    base.s.size = 0;
 85c:	89 0d a8 0b 00 00    	mov    %ecx,0xba8
