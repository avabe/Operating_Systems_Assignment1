...
int main(int argc, char *argv[]){
   ...
   1:	b8 68 07 00 00       	mov    $0x768,%eax
int main(int argc, char *argv[]){
   6:	89 e5                	mov    %esp,%ebp
  ...
  19:	e8 d2 03 00 00       	call   3f0 <printf>
    exit(0);
  ...
  51:	31 d2                	xor    %edx,%edx
{
  ...
  59:	53                   	push   %ebx
  5a:	8b 75 0c             	mov    0xc(%ebp),%esi
  5d:	8b 5d 10             	mov    0x10(%ebp),%ebx
    while((n--) > 0 && ((*s++ = *t++) != 0));
  60:	eb 12                	jmp    74 <strncpy+0x24>
  62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  68:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
  6c:	88 0c 10             	mov    %cl,(%eax,%edx,1)
  6f:	42                   	inc    %edx
  70:	84 c9                	test   %cl,%cl
  72:	74 08                	je     7c <strncpy+0x2c>
  74:	89 d9                	mov    %ebx,%ecx
  76:	29 d1                	sub    %edx,%ecx
  78:	85 c9                	test   %ecx,%ecx
  7a:	7f ec                	jg     68 <strncpy+0x18>
    return os;
}
  7c:	5b                   	pop    %ebx
  7d:	5e                   	pop    %esi
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c8:	e9 7e fe ff ff       	jmp    44b <printf+0x5b>
          s = "(null)";
 5cd:	bb 94 07 00 00       	mov    $0x794,%ebx
        while(*s != 0){
 ...
 5e1:	a1 50 0a 00 00       	mov    0xa50,%eax
{
 ...
 627:	5b                   	pop    %ebx
  freep = p;
 628:	a3 50 0a 00 00       	mov    %eax,0xa50
}
 62d:	5e                   	pop    %esi
 62e:	5f                   	pop    %edi
 62f:	5d                   	pop    %ebp
 ...
 63e:	72 ce                	jb     60e <free+0x2e>
{
 ...
 661:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 664:	a3 50 0a 00 00       	mov    %eax,0xa50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f1:	e8 ea fe ff ff       	call   5e0 <free>
  return freep;
 6f6:	8b 15 50 0a 00 00    	mov    0xa50,%edx
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	b8 54 0a 00 00       	mov    $0xa54,%eax
 735:	ba 54 0a 00 00       	mov    $0xa54,%edx
    base.s.size = 0;
 73a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 73c:	a3 50 0a 00 00       	mov    %eax,0xa50
    base.s.size = 0;
 741:	b8 54 0a 00 00       	mov    $0xa54,%eax
    base.s.ptr = freep = prevp = &base;
 746:	89 15 54 0a 00 00    	mov    %edx,0xa54
    base.s.size = 0;
 74c:	89 0d 58 0a 00 00    	mov    %ecx,0xa58
