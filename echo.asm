...
main(int argc, char *argv[])
{
  ...
  20:	ba b8 07 00 00       	mov    $0x7b8,%edx
  25:	b9 ba 07 00 00       	mov    $0x7ba,%ecx
  ...
  4c:	c7 44 24 0c bf 07 00 	movl   $0x7bf,0xc(%esp)
  53:	00 
  54:	89 44 24 08          	mov    %eax,0x8(%esp)
  58:	c7 44 24 04 ba 07 00 	movl   $0x7ba,0x4(%esp)
  5f:	00 
  60:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  67:	e8 d4 03 00 00       	call   440 <printf>
  exit(0);
  6c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  73:	e8 60 02 00 00       	call   2d8 <exit>
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 618:	e9 7e fe ff ff       	jmp    49b <printf+0x5b>
          s = "(null)";
 61d:	bb c1 07 00 00       	mov    $0x7c1,%ebx
        while(*s != 0){
 ...
 631:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 677:	5b                   	pop    %ebx
  freep = p;
 678:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 67d:	5e                   	pop    %esi
 67e:	5f                   	pop    %edi
 67f:	5d                   	pop    %ebp
 ...
 68e:	72 ce                	jb     65e <free+0x2e>
{
 ...
 6b1:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 6b4:	a3 80 0a 00 00       	mov    %eax,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71f:	73 3f                	jae    760 <malloc+0x90>
    ...
    if(p == freep)
 721:	39 05 80 0a 00 00    	cmp    %eax,0xa80
 ...
 741:	e8 ea fe ff ff       	call   630 <free>
  return freep;
 746:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 78a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 78c:	a3 80 0a 00 00       	mov    %eax,0xa80
    base.s.size = 0;
 791:	b8 84 0a 00 00       	mov    $0xa84,%eax
    base.s.ptr = freep = prevp = &base;
 796:	89 15 84 0a 00 00    	mov    %edx,0xa84
    base.s.size = 0;
 79c:	89 0d 88 0a 00 00    	mov    %ecx,0xa88
