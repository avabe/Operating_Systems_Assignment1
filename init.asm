   ...
   1:	b9 02 00 00 00       	mov    $0x2,%ecx
{
  ...
  1a:	e8 a9 03 00 00       	call   3c8 <open>
  ...
  2e:	e8 cd 03 00 00       	call   400 <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 c1 03 00 00       	call   400 <dup>
  3f:	90                   	nop

  for(;;){
    printf(1, "init: starting sh\n");
  40:	ba 70 08 00 00       	mov    $0x870,%edx
  45:	89 54 24 04          	mov    %edx,0x4(%esp)
  49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  50:	e8 9b 04 00 00       	call   4f0 <printf>
    pid = fork();
  55:	e8 26 03 00 00       	call   380 <fork>
    if(pid < 0){
  ...
  77:	e8 14 03 00 00       	call   390 <wait>
  ...
  a0:	eb ce                	jmp    70 <main+0x70>
      printf(1, "init: fork failed\n");
  a2:	c7 44 24 04 83 08 00 	movl   $0x883,0x4(%esp)
  a9:	00 
  aa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  b1:	e8 3a 04 00 00       	call   4f0 <printf>
      exit(0);
  b6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  bd:	e8 c6 02 00 00       	call   388 <exit>
      exec("sh", argv);
  c2:	c7 44 24 04 74 0b 00 	movl   $0xb74,0x4(%esp)
  c9:	00 
  ca:	c7 04 24 96 08 00 00 	movl   $0x896,(%esp)
  d1:	e8 ea 02 00 00       	call   3c0 <exec>
      printf(1, "init: exec sh failed\n");
  d6:	c7 44 24 04 99 08 00 	movl   $0x899,0x4(%esp)
  dd:	00 
  de:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e5:	e8 06 04 00 00       	call   4f0 <printf>
      exit(0);
  ea:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  f1:	e8 92 02 00 00       	call   388 <exit>
    mknod("console", 1, 1);
  f6:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  fd:	00 
  fe:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
 105:	00 
 106:	c7 04 24 68 08 00 00 	movl   $0x868,(%esp)
 10d:	e8 be 02 00 00       	call   3d0 <mknod>
    open("console", O_RDWR);
 112:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 119:	00 
 11a:	c7 04 24 68 08 00 00 	movl   $0x868,(%esp)
 121:	e8 a2 02 00 00       	call   3c8 <open>
 ...
 151:	31 d2                	xor    %edx,%edx
{
 ...
 159:	53                   	push   %ebx
 15a:	8b 75 0c             	mov    0xc(%ebp),%esi
 15d:	8b 5d 10             	mov    0x10(%ebp),%ebx
    while((n--) > 0 && ((*s++ = *t++) != 0));
 160:	eb 12                	jmp    174 <strncpy+0x24>
 162:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 168:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
 16c:	88 0c 10             	mov    %cl,(%eax,%edx,1)
 16f:	42                   	inc    %edx
 170:	84 c9                	test   %cl,%cl
 172:	74 08                	je     17c <strncpy+0x2c>
 174:	89 d9                	mov    %ebx,%ecx
 176:	29 d1                	sub    %edx,%ecx
 178:	85 c9                	test   %ecx,%ecx
 17a:	7f ec                	jg     168 <strncpy+0x18>
    return os;
}
 17c:	5b                   	pop    %ebx
 17d:	5e                   	pop    %esi
...
printf(int fd, const char *fmt, ...)
{
 ...
 6c8:	e9 7e fe ff ff       	jmp    54b <printf+0x5b>
          s = "(null)";
 6cd:	bb b8 08 00 00       	mov    $0x8b8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 7c 0b 00 00       	mov    0xb7c,%eax
{
 ...
 727:	5b                   	pop    %ebx
  freep = p;
 728:	a3 7c 0b 00 00       	mov    %eax,0xb7c
}
 72d:	5e                   	pop    %esi
 72e:	5f                   	pop    %edi
 72f:	5d                   	pop    %ebp
 ...
 73e:	72 ce                	jb     70e <free+0x2e>
{
 ...
 761:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 764:	a3 7c 0b 00 00       	mov    %eax,0xb7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 3f                	jae    810 <malloc+0x90>
    ...
    if(p == freep)
 7d1:	39 05 7c 0b 00 00    	cmp    %eax,0xb7c
 ...
 7f1:	e8 ea fe ff ff       	call   6e0 <free>
  return freep;
 7f6:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
 ...
 81c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 81f:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
}
 ...
 82f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 830:	b8 80 0b 00 00       	mov    $0xb80,%eax
 835:	ba 80 0b 00 00       	mov    $0xb80,%edx
    base.s.size = 0;
 83a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 83c:	a3 7c 0b 00 00       	mov    %eax,0xb7c
    base.s.size = 0;
 841:	b8 80 0b 00 00       	mov    $0xb80,%eax
    base.s.ptr = freep = prevp = &base;
 846:	89 15 80 0b 00 00    	mov    %edx,0xb80
    base.s.size = 0;
 84c:	89 0d 84 0b 00 00    	mov    %ecx,0xb84
