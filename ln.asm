   ...
   a:	83 7d 08 03          	cmpl   $0x3,0x8(%ebp)
{
  ...
  2e:	e8 a5 02 00 00       	call   2d8 <exit>
  }
...
printf(int fd, const char *fmt, ...)
{
 ...
 618:	e9 7e fe ff ff       	jmp    49b <printf+0x5b>
          s = "(null)";
 61d:	bb df 07 00 00       	mov    $0x7df,%ebx
        while(*s != 0){
 ...
 631:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 677:	5b                   	pop    %ebx
  freep = p;
 678:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
 67d:	5e                   	pop    %esi
 67e:	5f                   	pop    %edi
 67f:	5d                   	pop    %ebp
 ...
 68e:	72 ce                	jb     65e <free+0x2e>
{
 ...
 6b1:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 6b4:	a3 9c 0a 00 00       	mov    %eax,0xa9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 3f                	jae    760 <malloc+0x90>
    ...
    if(p == freep)
 721:	39 05 9c 0a 00 00    	cmp    %eax,0xa9c
 ...
 741:	e8 ea fe ff ff       	call   630 <free>
  return freep;
 746:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 76f:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	b8 a0 0a 00 00       	mov    $0xaa0,%eax
 785:	ba a0 0a 00 00       	mov    $0xaa0,%edx
    base.s.size = 0;
 78a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 78c:	a3 9c 0a 00 00       	mov    %eax,0xa9c
    base.s.size = 0;
 791:	b8 a0 0a 00 00       	mov    $0xaa0,%eax
    base.s.ptr = freep = prevp = &base;
 796:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
    base.s.size = 0;
 79c:	89 0d a4 0a 00 00    	mov    %ecx,0xaa4
