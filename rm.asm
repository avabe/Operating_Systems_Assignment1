...
main(int argc, char *argv[])
{
  ...
  25:	e8 fe 02 00 00       	call   328 <unlink>
  ...
  3d:	e8 96 02 00 00       	call   2d8 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  42:	8b 03                	mov    (%ebx),%eax
  44:	c7 44 24 04 cc 07 00 	movl   $0x7cc,0x4(%esp)
  4b:	00 
  ...
  a1:	31 d2                	xor    %edx,%edx
{
  ...
  a9:	53                   	push   %ebx
  aa:	8b 75 0c             	mov    0xc(%ebp),%esi
  ad:	8b 5d 10             	mov    0x10(%ebp),%ebx
    while((n--) > 0 && ((*s++ = *t++) != 0));
  b0:	eb 12                	jmp    c4 <strncpy+0x24>
  b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  b8:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
  bc:	88 0c 10             	mov    %cl,(%eax,%edx,1)
  bf:	42                   	inc    %edx
  c0:	84 c9                	test   %cl,%cl
  c2:	74 08                	je     cc <strncpy+0x2c>
  c4:	89 d9                	mov    %ebx,%ecx
  c6:	29 d1                	sub    %edx,%ecx
  c8:	85 c9                	test   %ecx,%ecx
  ca:	7f ec                	jg     b8 <strncpy+0x18>
    return os;
}
  cc:	5b                   	pop    %ebx
  cd:	5e                   	pop    %esi
 ...
 3ae:	84 db                	test   %bl,%bl
{
 ...
 417:	e8 dc fe ff ff       	call   2f8 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 493:	e8 60 fe ff ff       	call   2f8 <write>
 ...
 4fe:	e8 f5 fd ff ff       	call   2f8 <write>
 ...
 519:	e8 da fd ff ff       	call   2f8 <write>
  for(i = 0; fmt[i]; i++){
 ...
 597:	e8 5c fd ff ff       	call   2f8 <write>
        while(*s != 0){
 ...
 5de:	e8 15 fd ff ff       	call   2f8 <write>
      state = 0;
 ...
 60e:	e8 e5 fc ff ff       	call   2f8 <write>
      state = 0;
 ...
 618:	e9 7e fe ff ff       	jmp    49b <printf+0x5b>
          s = "(null)";
 61d:	bb e5 07 00 00       	mov    $0x7e5,%ebx
        while(*s != 0){
 ...
 631:	a1 a4 0a 00 00       	mov    0xaa4,%eax
{
 ...
 677:	5b                   	pop    %ebx
  freep = p;
 678:	a3 a4 0a 00 00       	mov    %eax,0xaa4
}
 67d:	5e                   	pop    %esi
 67e:	5f                   	pop    %edi
 67f:	5d                   	pop    %ebp
 ...
 68e:	72 ce                	jb     65e <free+0x2e>
{
 ...
 6b1:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 6b4:	a3 a4 0a 00 00       	mov    %eax,0xaa4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 a4 0a 00 00    	mov    0xaa4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 741:	e8 ea fe ff ff       	call   630 <free>
  return freep;
 746:	8b 15 a4 0a 00 00    	mov    0xaa4,%edx
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 76f:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	b8 a8 0a 00 00       	mov    $0xaa8,%eax
 785:	ba a8 0a 00 00       	mov    $0xaa8,%edx
    base.s.size = 0;
 78a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 78c:	a3 a4 0a 00 00       	mov    %eax,0xaa4
    base.s.size = 0;
 791:	b8 a8 0a 00 00       	mov    $0xaa8,%eax
    base.s.ptr = freep = prevp = &base;
 796:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
    base.s.size = 0;
 79c:	89 0d ac 0a 00 00    	mov    %ecx,0xaac
